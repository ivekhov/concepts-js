/*
https://ru.hexlet.io/challenges/intro_to_programming_ackermann_exercise
...
Эта функция растёт очень быстро, например, число A(4,4) настолько велико, что количество цифр 
